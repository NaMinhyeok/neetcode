...
| 난이도 | Medium |
| 카테고리 | Intervals |
| NeetCode | [문제 링크](https://neetcode.io/problems/meeting-rooms-ii) |
| LeetCode | [문제 링크](https://leetcode.com/problems/meeting-rooms-ii/) |
| 영상 풀이 | [NeetCode YouTube](https://www.youtube.com/watch?v=FdzJmTCVyJU) |
...
*이 문제는 LeetCode Premium 문제입니다.*

[LeetCode에서 보기](https://leetcode.com/problems/meeting-rooms-ii/)
