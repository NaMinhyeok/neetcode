...
| 난이도 | Hard |
| 카테고리 | Intervals |
| NeetCode | [문제 링크](https://neetcode.io/problems/minimum-interval-to-include-each-query) |
| LeetCode | [문제 링크](https://leetcode.com/problems/minimum-interval-to-include-each-query/) |
| 영상 풀이 | [NeetCode YouTube](https://www.youtube.com/watch?v=5hQ5WWW5awQ) |
