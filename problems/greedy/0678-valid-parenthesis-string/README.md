...
| 난이도 | Medium |
| 카테고리 | Greedy |
| NeetCode | [문제 링크](https://neetcode.io/problems/valid-parenthesis-string) |
| LeetCode | [문제 링크](https://leetcode.com/problems/valid-parenthesis-string/) |
| 영상 풀이 | [NeetCode YouTube](https://www.youtube.com/watch?v=QhPdNS143Qg) |
