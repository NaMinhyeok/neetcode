...
|------|------|
| 난이도 | Easy |
| 카테고리 | Heap / Priority Queue |
| NeetCode | [문제 링크](https://neetcode.io/problems/kth-largest-element-in-a-stream) |
| LeetCode | [문제 링크](https://leetcode.com/problems/kth-largest-element-in-a-stream/) |
| 영상 풀이 | [NeetCode YouTube](https://www.youtube.com/watch?v=hOjcdrqMoQ8) |
