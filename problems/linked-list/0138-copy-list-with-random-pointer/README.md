...
| 난이도 | Medium |
| 카테고리 | Linked List |
| NeetCode | [문제 링크](https://neetcode.io/problems/copy-list-with-random-pointer) |
| LeetCode | [문제 링크](https://leetcode.com/problems/copy-list-with-random-pointer/) |
| 영상 풀이 | [NeetCode YouTube](https://www.youtube.com/watch?v=5Y2EiZST97Y) |
