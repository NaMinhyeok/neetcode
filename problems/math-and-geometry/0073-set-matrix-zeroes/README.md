...
| 난이도 | Medium |
| 카테고리 | Math & Geometry |
| NeetCode | [문제 링크](https://neetcode.io/problems/set-matrix-zeroes) |
| LeetCode | [문제 링크](https://leetcode.com/problems/set-matrix-zeroes/) |
| 영상 풀이 | [NeetCode YouTube](https://www.youtube.com/watch?v=T41rL0L3Pnw) |
